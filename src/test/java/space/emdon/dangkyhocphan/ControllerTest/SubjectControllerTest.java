...
public class SubjectControllerTest {
    ...
    void createController_invalidRequest_success() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/subjects")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$result.name")
                        .value("SQL"))
                .andExpect(MockMvcResultMatchers.jsonPath("$result.credits")
                        .value(4))
        ;
    ...
    void getSubjectCodeController_invalidRequest_success()throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/subjects/{code}", subjectCode)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.result.code")
                        .value("KTH101"))
    ...
    void deleteSubjectController_invalidRequest_success()throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .delete("/subjects/{code}", subjectCode)
                .with(csrf()))
                .andExpect(MockMvcResultMatchers.status().isOk());
        Mockito.verify(subjectService, Mockito
                .times(1))
