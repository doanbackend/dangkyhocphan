...
INVALID_REGISTRATION_DATE_RANGE(1510, "Registration start date must be before registration end date", HttpStatus.BAD_REQUEST),
...
INVALID_SCHEDULE_PERIOD(1706, "Start period must be less than end period", HttpStatus.BAD_REQUEST),
...
INVOICE_DELETE_FORBIDDEN(1703, "Invoice deletion is forbidden. Use update status instead", HttpStatus.FORBIDDEN),
